...
public class GameBoard2D extends JPanel {
     ...
     * @throws java.io.IOException if a file doesn't exist (or is unreadable, ...)
     */
     ...
     * @throws java.io.IOException if the file doesn't exist (or is unreadable, ...)
     */
     ...
     * @param boxId 
     */
    public void clearPiece(String name, int boxId){
        Graphics2D g = offscreenImage.createGraphics();
    ...
    /**
     * Convenience method.
     * @see gameboard2d.board.Board#addBox
     */
    ...
    /**
     * Convenience method.
     * @see gameboard2d.board.Board#getBoxId(java.awt.Point)
     */
